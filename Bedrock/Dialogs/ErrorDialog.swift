...
final class BRErrorDialog {
	
	class func showError(_ error: Error, from presentingViewController: UIViewController, dialogTitle: String? = nil, cancelButtonTitle: String = "OK") {
