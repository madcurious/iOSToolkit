//
//  BRDateUtilsTest_EndOfWeek.swift
//  BedrockTests
//
...
class BRDateUtilsTest_EndOfWeek: BRDateUtilsTest {
    ...
    fileprivate func doTest(date: (day: Int, month: Int, year: Int),
        ...
        let resultDate = BRDateUtils.endOfWeek(for: testDate, firstWeekday: firstWeekday)
